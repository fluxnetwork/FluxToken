...
contract('FluxToken', async ([ownerAddress,recipient,anotherAccount,approver]) => {
    ...
    describe('constructor()', function () {
        it('should require a valid owner address', async function () {
            ...
            await assertRevert(fluxToken.new(ZERO_ADDRESS, PREALLOCATED_SUPPLY));
        });
    });
    ...
    describe('burn()', function () {
        ...
        it('should emit events', async function () {
            ...
            assert.equal(logs[0].args._burner, ownerAddress);
    ...
    describe('transferFrom()', function() {
        ...
        describe('when the recipient is the Flux contract address', function () {
            const amount = 100;
            it('should revert', async function () {
